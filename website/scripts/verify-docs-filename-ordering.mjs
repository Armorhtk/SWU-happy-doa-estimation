...
const expectedDocs = [
  ...
  {
    path: path.join(repoRoot, "docs", "03-deep-learning-methods", "08-code-framework-implementation.md"),
    id: "deep-learning-code-framework-implementation",
    title: "3.7 深度学习DOA估计代码框架实现",
    slug: "/deep-learning/code-framework-implementation",
  },
  {
    path: path.join(repoRoot, "docs", "03-deep-learning-methods", "09-comparison-and-selection-with-classical-methods.md"),
  ...
  {
    path: path.join(repoRoot, "docs", "03-deep-learning-methods", "10-deep-unfolding-and-hybrid-paradigms.md"),
  ...
  {
    path: path.join(repoRoot, "docs", "04-research-practice", "05-sim2real-in-deep-learning-doa.md"),
    id: "research-practice-sim2real-in-deep-learning-doa",
    title: "4.4 【拓展】深度学习DOA估计中的Sim2Real问题",
    slug: "/research-practice/sim2real-in-deep-learning-doa",
    placeholder: true,
  },
  {
    path: path.join(repoRoot, "docs", "04-research-practice", "06-unsupervised-doa-methods.md"),
    id: "research-practice-unsupervised-doa-methods",
    title: "4.5 【拓展】无监督DOA估计方法",
    slug: "/research-practice/unsupervised-doa-methods",
    placeholder: true,
  },
  {
...
const forbiddenPaths = [
  ...
  path.join(repoRoot, "docs", "03-deep-learning-methods", "02-basic-tasks-and-workflow.md"),
  path.join(repoRoot, "docs", "03-deep-learning-methods", "03-dataset-construction-and-input-features.md"),
  path.join(repoRoot, "docs", "03-deep-learning-methods", "04-classification-based-methods.md"),
  path.join(repoRoot, "docs", "03-deep-learning-methods", "05-regression-based-methods.md"),
  path.join(repoRoot, "docs", "03-deep-learning-methods", "06-comparison-with-classical-methods.md"),
