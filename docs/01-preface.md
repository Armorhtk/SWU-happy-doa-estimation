...
这一章面向**没有系统深度学习基础**的读者，目标是以最低的必要成本进入基于深度学习的 DOA 估计世界。内容将从一个补充性质的深度学习基础速览开始，随后回答“为什么要引入深度学习”“任务该如何定义”“数据集如何构建”，再依次展开分类方法、直接角度回归、伪空间谱回归、代码框架实现，以及与经典方法的对比和进一步的深度展开思路。
